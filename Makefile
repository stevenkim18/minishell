...
UTIL = ft_handle_error.c ft_handle_pipe_one.c ft_handle_pipe_two.c ft_handle_process.c ft_handle_signal.c ft_handle_data.c ft_handle_index.c
UTIL_DIR = ./src/utils/
...
TEST_NAME = test.out
TEST = test.ft_trim_str.c test.ft_handle_pipe.c
TEST_DIR = ./src/test/
