...
COMMAND = ft_handle_command.c ft_exec_command.c ft_handle_pwd.c ft_verify_command.c ft_route_command.c ft_handle_built_in.c
...
TEST_NAME = test.out
TEST = test.ft_trim_str.c test.ft_handle_pipe.c test.ft_handle_error.c test.ft_get_char.c test.ft_verify_pipe.c test.ft_verify_semicolon.c test.ft_verify_command.c test.ft_get_command.c test.ft_get_env.c test.ft_check_home_dir.c test.ft_check_dir.c
TEST_DIR = ./src/test/
